...
class MultiQueryRetrieverBuilder:
    ...
    Use sinônimos acadêmicos adequados (ex: 'matéria' -> 'disciplina' ou 'unidade curricular', 'estágio' -> 'estágio supervisionado', 'horas' -> 'carga horária', 'conteúdo' -> 'ementa', 'prova' -> 'avaliação').
